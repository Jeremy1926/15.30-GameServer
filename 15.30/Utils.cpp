...
AActor* Utils::SpawnActor(UClass* Class, FTransform& Transform, AActor* Owner)
{
    ...
    return ((AActor * (*)(UWorld*, UClass*, FTransform const*, FActorSpawnParameters*))(ImageBase + 0x4f566f0))(UWorld::GetWorld(), Class, &Transform, &addr);
...
AActor* Utils::SpawnActor(UClass* Class, FVector& Loc, FRotator& Rot, AActor* Owner)
{
    ...
    return ((AActor * (*)(UWorld*, UClass*, FVector const*, FRotator const*, FActorSpawnParameters*))(ImageBase + 0x4f576c0))(UWorld::GetWorld(), Class, &Loc, &Rot, &addr);
}
