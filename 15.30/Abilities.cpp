...
void Abilities::InternalServerTryActivateAbility(UFortAbilitySystemComponentAthena* AbilitySystemComponent, FGameplayAbilitySpecHandle Handle, bool InputPressed, FPredictionKey& PredictionKey, FGameplayEventData* TriggerEventData) {
    ...
    auto Abilites = (bool (*)(UAbilitySystemComponent*, FGameplayAbilitySpecHandle, FPredictionKey, UGameplayAbility**, void*, const FGameplayEventData*)) (ImageBase + 0xa767c0);
...
void Abilities::GiveAbility(UAbilitySystemComponent* AbilitySystemComponent, UObject* Ability)
{
    ...
    ((void (*)(FGameplayAbilitySpec*, UGameplayAbility*, int, int, UObject*)) (ImageBase + 0xa4c210))(&Spec, (UGameplayAbility*)Ability, 1, -1, nullptr);
    ((FGameplayAbilitySpecHandle * (__fastcall*)(UAbilitySystemComponent*, FGameplayAbilitySpecHandle*, FGameplayAbilitySpec)) (ImageBase + 0xa6faf0))(AbilitySystemComponent, &Spec.Handle, Spec);
}
...
void Abilities::Hook() {
    Utils::HookEvery<UAbilitySystemComponent>(0xfe, InternalServerTryActivateAbility);
}
