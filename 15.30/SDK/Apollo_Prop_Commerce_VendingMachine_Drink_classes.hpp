...
static_assert(sizeof(AApollo_Prop_Commerce_VendingMachine_Drink_C) == 0x000C90, "Wrong size on AApollo_Prop_Commerce_VendingMachine_Drink_C");
static_assert(offsetof(AApollo_Prop_Commerce_VendingMachine_Drink_C, SpotLight) == 0x000C88, "Member 'AApollo_Prop_Commerce_VendingMachine_Drink_C::SpotLight' has a wrong offset!");
