...
static_assert(sizeof(UFortReplayHighlightsWindow_C) == 0x0004B0, "Wrong size on UFortReplayHighlightsWindow_C");
static_assert(offsetof(UFortReplayHighlightsWindow_C, UberGraphFrame) == 0x0004A0, "Member 'UFortReplayHighlightsWindow_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFortReplayHighlightsWindow_C, CloseButton) == 0x0004A8, "Member 'UFortReplayHighlightsWindow_C::CloseButton' has a wrong offset!");
