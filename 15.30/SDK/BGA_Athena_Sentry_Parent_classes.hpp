...
public:
	...
	class UAudioComponent*                        Rotation_Audio;                                    // 0x0938(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UCapsuleComponent*                      HitBox;                                            // 0x0940(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UFortLinkToActorComponent*              FortLinkToActor;                                   // 0x0948(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class USphereComponent*                       PawnActivationVolume;                              // 0x0950(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	float                                         TL_ScaleRays_Alpha_0131847C4194FDF20B5930855C58BE4F; // 0x0958(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ETimelineDirection                            TL_ScaleRays__Direction_0131847C4194FDF20B5930855C58BE4F; // 0x095C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_95D[0x3];                                      // 0x095D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UTimelineComponent*                     TL_ScaleRays;                                      // 0x0960(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         TargetingInterval;                                 // 0x0968(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_96C[0x4];                                      // 0x096C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           Timer_DoTargeting;                                 // 0x0970(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          UsesIgnoreTargetTags;                              // 0x0980(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	...
	struct FGameplayTag                           GC_Deactivated;                                    // 0x09A8(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	struct FScalableFloat                         Row_LostTargetDelay;                               // 0x0A18(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FVector                                LastKnownTargetLocation;                           // 0x0A40(0x000C)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A4C[0x4];                                      // 0x0A4C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           Timer_LostTarget;                                  // 0x0A50(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                             Rotation_Stop_Sound;                               // 0x0A58(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, UberGraphFrame) == 0x000930, "Member 'ABGA_Athena_Sentry_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, Rotation_Audio) == 0x000938, "Member 'ABGA_Athena_Sentry_Parent_C::Rotation_Audio' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, HitBox) == 0x000940, "Member 'ABGA_Athena_Sentry_Parent_C::HitBox' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, FortLinkToActor) == 0x000948, "Member 'ABGA_Athena_Sentry_Parent_C::FortLinkToActor' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, PawnActivationVolume) == 0x000950, "Member 'ABGA_Athena_Sentry_Parent_C::PawnActivationVolume' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, TL_ScaleRays_Alpha_0131847C4194FDF20B5930855C58BE4F) == 0x000958, "Member 'ABGA_Athena_Sentry_Parent_C::TL_ScaleRays_Alpha_0131847C4194FDF20B5930855C58BE4F' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, TL_ScaleRays__Direction_0131847C4194FDF20B5930855C58BE4F) == 0x00095C, "Member 'ABGA_Athena_Sentry_Parent_C::TL_ScaleRays__Direction_0131847C4194FDF20B5930855C58BE4F' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, TL_ScaleRays) == 0x000960, "Member 'ABGA_Athena_Sentry_Parent_C::TL_ScaleRays' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, TargetingInterval) == 0x000968, "Member 'ABGA_Athena_Sentry_Parent_C::TargetingInterval' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, Timer_DoTargeting) == 0x000970, "Member 'ABGA_Athena_Sentry_Parent_C::Timer_DoTargeting' has a wrong offset!");
...
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, UsesIgnoreTargetTags) == 0x000980, "Member 'ABGA_Athena_Sentry_Parent_C::UsesIgnoreTargetTags' has a wrong offset!");
...
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, GC_Deactivated) == 0x0009A8, "Member 'ABGA_Athena_Sentry_Parent_C::GC_Deactivated' has a wrong offset!");
...
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, LastKnownTargetLocation) == 0x000A40, "Member 'ABGA_Athena_Sentry_Parent_C::LastKnownTargetLocation' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, Timer_LostTarget) == 0x000A50, "Member 'ABGA_Athena_Sentry_Parent_C::Timer_LostTarget' has a wrong offset!");
static_assert(offsetof(ABGA_Athena_Sentry_Parent_C, Rotation_Stop_Sound) == 0x000A58, "Member 'ABGA_Athena_Sentry_Parent_C::Rotation_Stop_Sound' has a wrong offset!");
