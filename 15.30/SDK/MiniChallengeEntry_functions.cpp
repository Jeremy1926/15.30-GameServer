...
void UMiniChallengeEntry_C::ExecuteUbergraph_MiniChallengeEntry(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_MiniChallengeEntry");
...
void UMiniChallengeEntry_C::Play_Refresh_to_New()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Play Refresh to New");
...
void UMiniChallengeEntry_C::SetXpValue(int32 XpRewardValue)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetXpValue");
...
void UMiniChallengeEntry_C::Play_Fill_to_Complete_Post()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Play Fill to Complete Post");
...
void UMiniChallengeEntry_C::ResetProgressData()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ResetProgressData");
...
void UMiniChallengeEntry_C::UpdateQuestDescription(const class FText& Description)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateQuestDescription");
...
void UMiniChallengeEntry_C::UpdateProgressBar(int32 LastKnownCount_0, int32 AchivedCount_0, int32 GoalCount_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateProgressBar");
...
void UMiniChallengeEntry_C::FadeToastAway()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FadeToastAway");
...
void UMiniChallengeEntry_C::OnToastFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnToastFinished");
...
void UMiniChallengeEntry_C::CompetionToast()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CompetionToast");
...
void UMiniChallengeEntry_C::OnDeltaProgressToCompleteFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDeltaProgressToCompleteFinished");
...
void UMiniChallengeEntry_C::OnDeltaProgressFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnDeltaProgressFinished");
...
void UMiniChallengeEntry_C::TriggerNewQuestGranted()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TriggerNewQuestGranted");
...
void UMiniChallengeEntry_C::QuestCompletedFinishFill()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("QuestCompletedFinishFill");
...
void UMiniChallengeEntry_C::StyleAsFirstTimeBoosted()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StyleAsFirstTimeBoosted");
...
void UMiniChallengeEntry_C::StyleAsNormal()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StyleAsNormal");
...
void UMiniChallengeEntry_C::SequenceEvent__ENTRYPOINTMiniChallengeEntry_0()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SequenceEvent__ENTRYPOINTMiniChallengeEntry_0");
