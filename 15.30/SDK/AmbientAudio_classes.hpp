...
{
public:
	TMulticastInlineDelegate<void(struct FGameplayTag& GameplayTag, EAmbientAudioTagActionType ActionType)> OnTagChanged;                                      // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
