...
void UAlterationWidgetButton_C::Setup_Triangles()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Setup Triangles");
...
void UAlterationWidgetButton_C::Update_Colors()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Colors");
...
void UAlterationWidgetButton_C::IntroStart()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IntroStart");
...
void UAlterationWidgetButton_C::IntroReset()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("IntroReset");
...
void UAlterationWidgetButton_C::TriggerModificationAnimation()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TriggerModificationAnimation");
...
void UAlterationWidgetButton_C::ExecuteUbergraph_AlterationWidgetButton(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AlterationWidgetButton");
