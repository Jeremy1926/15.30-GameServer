...
static_assert(offsetof(UAthenaLocalPlayerHitPointInfo_C, UberGraphFrame) == 0x0002D8, "Member 'UAthenaLocalPlayerHitPointInfo_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaLocalPlayerHitPointInfo_C, FadeVehicle) == 0x0002E0, "Member 'UAthenaLocalPlayerHitPointInfo_C::FadeVehicle' has a wrong offset!");
static_assert(offsetof(UAthenaLocalPlayerHitPointInfo_C, FadeStatus) == 0x0002E8, "Member 'UAthenaLocalPlayerHitPointInfo_C::FadeStatus' has a wrong offset!");
static_assert(offsetof(UAthenaLocalPlayerHitPointInfo_C, AthenaCurieStatusWidget) == 0x0002F0, "Member 'UAthenaLocalPlayerHitPointInfo_C::AthenaCurieStatusWidget' has a wrong offset!");
static_assert(offsetof(UAthenaLocalPlayerHitPointInfo_C, AthenaHitPointBar_CNStorm2) == 0x0002F8, "Member 'UAthenaLocalPlayerHitPointInfo_C::AthenaHitPointBar_CNStorm2' has a wrong offset!");
