...
static_assert(sizeof(UTimelineMarker_C) == 0x000C80, "Wrong size on UTimelineMarker_C");
static_assert(offsetof(UTimelineMarker_C, UberGraphFrame) == 0x000C50, "Member 'UTimelineMarker_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UTimelineMarker_C, HoveredColor) == 0x000C58, "Member 'UTimelineMarker_C::HoveredColor' has a wrong offset!");
