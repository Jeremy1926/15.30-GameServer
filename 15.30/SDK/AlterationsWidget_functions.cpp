...
void UAlterationsWidget_C::ClearAndInitialize(bool IntroAlterations)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ClearAndInitialize");
...
void UAlterationsWidget_C::CreateAnimations(bool IntroAnims)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CreateAnimations");
...
void UAlterationsWidget_C::CenterWidget()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CenterWidget");
...
void UAlterationsWidget_C::SetupBorders()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupBorders");
...
void UAlterationsWidget_C::TriggerModificationAnim(int32 ModifiedSlotIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TriggerModificationAnim");
...
void UAlterationsWidget_C::SetupAlteration(class UCommonUserWidget* Alteration, class UFortAlterationInfo* AlterationInfo)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupAlteration");
...
class UCommonUserWidget* UAlterationsWidget_C::CreateAlterationWidget()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CreateAlterationWidget");
...
void UAlterationsWidget_C::GenerateAlteration(class UFortAlterationInfo* AlterationInfo)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GenerateAlteration");
...
void UAlterationsWidget_C::AddAlterationToVerticalbox(class UCommonUserWidget* Alteration, bool IsUnlocked)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AddAlterationToVerticalbox");
...
void UAlterationsWidget_C::UpdatePerksMessage()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdatePerksMessage");
...
void UAlterationsWidget_C::OnItemToCompareWithChanged()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnItemToCompareWithChanged");
...
void UAlterationsWidget_C::OnGenerateAlteration(class UFortAlterationInfo* AlterationInfo)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnGenerateAlteration");
...
void UAlterationsWidget_C::OnFocusFirstItem()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnFocusFirstItem");
...
void UAlterationsWidget_C::OnAlterationSlotIndexModifiedBP(int32 ModifiedIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnAlterationSlotIndexModifiedBP");
...
void UAlterationsWidget_C::OnUpgradeLevelDeltaChanged()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnUpgradeLevelDeltaChanged");
...
void UAlterationsWidget_C::ExecuteUbergraph_AlterationsWidget(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AlterationsWidget");
