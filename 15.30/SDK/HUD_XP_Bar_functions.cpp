...
void UHUD_XP_Bar_C::ExecuteUbergraph_HUD_XP_Bar(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_HUD_XP_Bar");
...
void UHUD_XP_Bar_C::XpBarFillFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("XpBarFillFinished");
...
void UHUD_XP_Bar_C::HideXpBar()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HideXpBar");
...
void UHUD_XP_Bar_C::SetRestedVisuals()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetRestedVisuals");
...
void UHUD_XP_Bar_C::InitilizeBar(int32 CurrentLevel, int32 CurrentXp, int32 TotalXp)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitilizeBar");
...
void UHUD_XP_Bar_C::UpdateBar(int32 XpToGain, int32 CurrentDisplayXp, int32 XpToLevel, int32 CurrentLevel, int32 TotalRestXpRemaining, bool bIsXPBarOnly)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateBar");
