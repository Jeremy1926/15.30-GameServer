...
static_assert(sizeof(AAgency_Planter_03_C) == 0x000C90, "Wrong size on AAgency_Planter_03_C");
static_assert(offsetof(AAgency_Planter_03_C, Loot_Effect) == 0x000C88, "Member 'AAgency_Planter_03_C::Loot_Effect' has a wrong offset!");
