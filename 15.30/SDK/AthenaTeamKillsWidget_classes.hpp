...
static_assert(sizeof(UAthenaTeamKillsWidget_C) == 0x0002E0, "Wrong size on UAthenaTeamKillsWidget_C");
static_assert(offsetof(UAthenaTeamKillsWidget_C, UberGraphFrame) == 0x0002D8, "Member 'UAthenaTeamKillsWidget_C::UberGraphFrame' has a wrong offset!");
