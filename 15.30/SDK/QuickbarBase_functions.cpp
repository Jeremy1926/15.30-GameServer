...
void UQuickbarBase_C::ExecuteUbergraph_QuickbarBase(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_QuickbarBase");
...
void UQuickbarBase_C::OnLocalPlayerSpawned()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLocalPlayerSpawned");
...
void UQuickbarBase_C::OnLocalPlayerRevived()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLocalPlayerRevived");
...
void UQuickbarBase_C::OnLocalPlayerDied(const struct FFortPlayerDeathReport& DeathReport)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLocalPlayerDied");
...
void UQuickbarBase_C::OnQuickbarSecondarySlotFocusChanged_Event_0(EFortQuickBars QuickbarIndex, int32 Slot_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnQuickbarSecondarySlotFocusChanged_Event_0");
...
void UQuickbarBase_C::OnQuickbarForceFullUpdate(EFortQuickBars QuickbarIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnQuickbarForceFullUpdate");
...
void UQuickbarBase_C::OnQuickbarSlotFocusChanged(EFortQuickBars QuickbarIndex, int32 Slot_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnQuickbarSlotFocusChanged");
...
void UQuickbarBase_C::OnWorldItemListChanged(const TArray<class UFortWorldItem*>& ItemsAdded, const TArray<class UFortWorldItem*>& ItemsRemoved)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnWorldItemListChanged");
...
void UQuickbarBase_C::Is_Valid_Slot(int32 Slot_0, bool* Is_Valid, int32* Array_Index)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Is Valid Slot");
...
void UQuickbarBase_C::Maximize()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Maximize");
...
void UQuickbarBase_C::Minimize()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Minimize");
...
void UQuickbarBase_C::RefreshQuickbar()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RefreshQuickbar");
...
void UQuickbarBase_C::ShouldRefreshQuickbarItem(int32 RequestedSlot, int32 CurrentSlot, bool* Result)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldRefreshQuickbarItem");
...
void UQuickbarBase_C::UpdateCurrentFocusedQuickbar(EFortQuickBars* PreviousFocusedQuickbar, EFortQuickBars* CurrentFocusedQuickbar)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateCurrentFocusedQuickbar");
...
void UQuickbarBase_C::HandleQuickbarContentChanged(EFortQuickBars QuickBarType, TArray<int32>& ChangedSlots)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleQuickbarContentChanged");
...
void UQuickbarBase_C::StopUsingAllSlots()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StopUsingAllSlots");
...
void UQuickbarBase_C::UpdateInventoryCapacity()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateInventoryCapacity");
