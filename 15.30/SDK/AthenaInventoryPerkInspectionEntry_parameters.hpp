...
static_assert(offsetof(AthenaInventoryPerkInspectionEntry_C_Update, SpyTechItemDef_0) == 0x000000, "Member 'AthenaInventoryPerkInspectionEntry_C_Update::SpyTechItemDef_0' has a wrong offset!");
