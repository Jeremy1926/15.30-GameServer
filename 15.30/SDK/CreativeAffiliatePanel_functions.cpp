...
void UCreativeAffiliatePanel_C::ExecuteUbergraph_CreativeAffiliatePanel(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_CreativeAffiliatePanel");
...
void UCreativeAffiliatePanel_C::On_Success()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Success");
...
void UCreativeAffiliatePanel_C::PopupClosed()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("PopupClosed");
...
void UCreativeAffiliatePanel_C::SetAffiliateName(const class FText& AffiliateName)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetAffiliateName");
