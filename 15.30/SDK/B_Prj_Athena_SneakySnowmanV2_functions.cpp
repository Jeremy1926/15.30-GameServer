...
void AB_Prj_Athena_SneakySnowmanV2_C::ExecuteUbergraph_B_Prj_Athena_SneakySnowmanV2(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_B_Prj_Athena_SneakySnowmanV2");
...
void AB_Prj_Athena_SneakySnowmanV2_C::Apply_Snowman_To_Self()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Apply Snowman To Self");
...
void AB_Prj_Athena_SneakySnowmanV2_C::Should_Bounce_(const struct FVector& Hit_Normal)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Should Bounce?");
...
bool AB_Prj_Athena_SneakySnowmanV2_C::ShouldApplySnowman_(class UObject* PlayerPawn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldApplySnowman?");
...
void AB_Prj_Athena_SneakySnowmanV2_C::UpdateQuest(class AFortPlayerController* FortPC)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateQuest");
