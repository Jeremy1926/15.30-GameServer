...
static_assert(sizeof(ARanger_Lightpost_C) == 0x000C90, "Wrong size on ARanger_Lightpost_C");
static_assert(offsetof(ARanger_Lightpost_C, PointLight) == 0x000C88, "Member 'ARanger_Lightpost_C::PointLight' has a wrong offset!");
