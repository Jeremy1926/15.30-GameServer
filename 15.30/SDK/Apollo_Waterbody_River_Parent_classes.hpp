...
{
public:
	class UFortSplineWaterAudioComponent*         FortSplineWaterAudio;                              // 0x0F98(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AApollo_Waterbody_River_Parent_C) == 0x000FA0, "Wrong size on AApollo_Waterbody_River_Parent_C");
static_assert(offsetof(AApollo_Waterbody_River_Parent_C, FortSplineWaterAudio) == 0x000F98, "Member 'AApollo_Waterbody_River_Parent_C::FortSplineWaterAudio' has a wrong offset!");
