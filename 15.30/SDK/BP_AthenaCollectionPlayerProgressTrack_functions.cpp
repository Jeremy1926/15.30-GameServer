...
void UBP_AthenaCollectionPlayerProgressTrack_C::ExecuteUbergraph_BP_AthenaCollectionPlayerProgressTrack(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_AthenaCollectionPlayerProgressTrack");
...
// Parameters:
// TArray<class UAthenaCollectionPlayerProgress*>PlayerProgressEntries                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference, HasGetValueTypeHash)
