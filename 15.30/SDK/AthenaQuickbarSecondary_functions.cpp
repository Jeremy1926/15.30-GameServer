...
void UAthenaQuickbarSecondary_C::ExecuteUbergraph_AthenaQuickbarSecondary(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaQuickbarSecondary");
...
void UAthenaQuickbarSecondary_C::Show_Secondary_Quickbar_Rail(bool Show)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Show Secondary Quickbar Rail");
...
void UAthenaQuickbarSecondary_C::HandleKeyBindsChange()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleKeyBindsChange");
...
void UAthenaQuickbarSecondary_C::HandleShowHideRail()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleShowHideRail");
