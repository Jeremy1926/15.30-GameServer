...
{
public:
	class UAudioComponent*                        PowerPlant_Vat_Cue;                                // 0x0BA8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AApollo_PowerPlant_ReactorCore_01_C) == 0x000BB0, "Wrong size on AApollo_PowerPlant_ReactorCore_01_C");
static_assert(offsetof(AApollo_PowerPlant_ReactorCore_01_C, PowerPlant_Vat_Cue) == 0x000BA8, "Member 'AApollo_PowerPlant_ReactorCore_01_C::PowerPlant_Vat_Cue' has a wrong offset!");
