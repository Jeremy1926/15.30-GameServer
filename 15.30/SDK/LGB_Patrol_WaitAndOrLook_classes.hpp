...
public:
	...
	float                                         ChanceToWait;                                      // 0x0254(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ALGB_Patrol_WaitAndOrLook_C) == 0x000258, "Wrong size on ALGB_Patrol_WaitAndOrLook_C");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, UberGraphFrame) == 0x000230, "Member 'ALGB_Patrol_WaitAndOrLook_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, DirectionArrow) == 0x000238, "Member 'ALGB_Patrol_WaitAndOrLook_C::DirectionArrow' has a wrong offset!");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, TextRender) == 0x000240, "Member 'ALGB_Patrol_WaitAndOrLook_C::TextRender' has a wrong offset!");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, WaitTimeMin) == 0x000248, "Member 'ALGB_Patrol_WaitAndOrLook_C::WaitTimeMin' has a wrong offset!");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, WaitTimeMax) == 0x00024C, "Member 'ALGB_Patrol_WaitAndOrLook_C::WaitTimeMax' has a wrong offset!");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, LookWhileWaiting) == 0x000250, "Member 'ALGB_Patrol_WaitAndOrLook_C::LookWhileWaiting' has a wrong offset!");
static_assert(offsetof(ALGB_Patrol_WaitAndOrLook_C, ChanceToWait) == 0x000254, "Member 'ALGB_Patrol_WaitAndOrLook_C::ChanceToWait' has a wrong offset!");
