...
void ADA_SpookyMist_C::ExecuteUbergraph_DA_SpookyMist(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_DA_SpookyMist");
...
void ADA_SpookyMist_C::On_DBNO()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On DBNO");
...
void ADA_SpookyMist_C::CanCancel()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CanCancel");
...
void ADA_SpookyMist_C::BPReleaseSecondaryFire(class AFortDecoHelper* FortDecoHelper)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BPReleaseSecondaryFire");
...
void ADA_SpookyMist_C::BPOnUnEquip()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BPOnUnEquip");
...
void ADA_SpookyMist_C::BPPressSecondaryFire(class AFortDecoHelper* FortDecoHelper)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BPPressSecondaryFire");
