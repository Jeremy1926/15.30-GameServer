...
static_assert(sizeof(UAthenaServerAddress_C) == 0x0002D8, "Wrong size on UAthenaServerAddress_C");
static_assert(offsetof(UAthenaServerAddress_C, UberGraphFrame) == 0x0002C8, "Member 'UAthenaServerAddress_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaServerAddress_C, Text) == 0x0002D0, "Member 'UAthenaServerAddress_C::Text' has a wrong offset!");
