...
static_assert(offsetof(AthenaStormSurgeWidget_C_OnUpdateThresholdDisplay, ThresholdText_0) == 0x000000, "Member 'AthenaStormSurgeWidget_C_OnUpdateThresholdDisplay::ThresholdText_0' has a wrong offset!");
