...
public:
	...
	bool                                          CallFunc_IsBattleLabModePlaylist_ReturnValue;      // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsCreativeOrPlaygroundModePlaylist_ReturnValue; // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(Apollo_BR_BoundaryActor_C_IsInCreativePlaylist, CallFunc_IsBattleLabModePlaylist_ReturnValue) == 0x000010, "Member 'Apollo_BR_BoundaryActor_C_IsInCreativePlaylist::CallFunc_IsBattleLabModePlaylist_ReturnValue' has a wrong offset!");
static_assert(offsetof(Apollo_BR_BoundaryActor_C_IsInCreativePlaylist, CallFunc_IsCreativeOrPlaygroundModePlaylist_ReturnValue) == 0x000011, "Member 'Apollo_BR_BoundaryActor_C_IsInCreativePlaylist::CallFunc_IsCreativeOrPlaygroundModePlaylist_ReturnValue' has a wrong offset!");
static_assert(offsetof(Apollo_BR_BoundaryActor_C_IsInCreativePlaylist, CallFunc_Not_PreBool_ReturnValue) == 0x000012, "Member 'Apollo_BR_BoundaryActor_C_IsInCreativePlaylist::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Apollo_BR_BoundaryActor_C_IsInCreativePlaylist, CallFunc_IsValid_ReturnValue) == 0x000013, "Member 'Apollo_BR_BoundaryActor_C_IsInCreativePlaylist::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Apollo_BR_BoundaryActor_C_IsInCreativePlaylist, CallFunc_BooleanAND_ReturnValue) == 0x000014, "Member 'Apollo_BR_BoundaryActor_C_IsInCreativePlaylist::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
