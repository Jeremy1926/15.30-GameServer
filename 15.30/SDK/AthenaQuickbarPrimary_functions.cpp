...
void UAthenaQuickbarPrimary_C::ExecuteUbergraph_AthenaQuickbarPrimary(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaQuickbarPrimary");
...
void UAthenaQuickbarPrimary_C::OnQuickBarSlotFocusChanged_Bind(EFortQuickBars QuickbarIndex, int32 Slot_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnQuickBarSlotFocusChanged_Bind");
...
void UAthenaQuickbarPrimary_C::HandleInputMethodChanged_Bind(ECommonInputType InputType)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleInputMethodChanged_Bind");
...
void UAthenaQuickbarPrimary_C::OnReady_ECD8F67D499AA47681F88E9746363B9F(class AFortGameStateAthena* GameState, const class UFortPlaylist* Playlist, const struct FGameplayTagContainer& PlaylistContextTags)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnReady_ECD8F67D499AA47681F88E9746363B9F");
...
void UAthenaQuickbarPrimary_C::Show_Primary_Quickbar_Rail(bool Show)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Show Primary Quickbar Rail");
...
void UAthenaQuickbarPrimary_C::HasOneNonHarvestWeapon(bool* HasNonHarvestWeapon)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HasOneNonHarvestWeapon");
...
void UAthenaQuickbarPrimary_C::HandleShowHideWeaponRail()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleShowHideWeaponRail");
...
void UAthenaQuickbarPrimary_C::SetQuickBarNativeMode(bool bNativeMode)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetQuickBarNativeMode");
...
void UAthenaQuickbarPrimary_C::HandleInteractionChanged(class UFortInteractContextInfo* Context_Info)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleInteractionChanged");
...
void UAthenaQuickbarPrimary_C::RefreshPickupPreview()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RefreshPickupPreview");
...
class UFortQuickBarSlotBase* UAthenaQuickbarPrimary_C::GetSpecificSlot(int32 SlotNumber)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSpecificSlot");
