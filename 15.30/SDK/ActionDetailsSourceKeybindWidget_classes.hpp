...
static_assert(sizeof(UActionDetailsSourceKeybindWidget_C) == 0x0008F8, "Wrong size on UActionDetailsSourceKeybindWidget_C");
static_assert(offsetof(UActionDetailsSourceKeybindWidget_C, ActionSource) == 0x0008E8, "Member 'UActionDetailsSourceKeybindWidget_C::ActionSource' has a wrong offset!");
