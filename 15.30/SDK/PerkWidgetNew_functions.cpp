...
void UPerkWidgetNew_C::SetDescriptionWraptTextAt(float WrapTextAt)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetDescriptionWraptTextAt");
...
void UPerkWidgetNew_C::UpdatePerk()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdatePerk");
...
class UWidget* UPerkWidgetNew_C::Get_OverlayAbilityPerk_ToolTipWidget()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Get_OverlayAbilityPerk_ToolTipWidget");
...
void UPerkWidgetNew_C::HighlightBadge()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HighlightBadge");
...
void UPerkWidgetNew_C::GetPerkStat(struct FTooltipStat* TooltipStat)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetPerkStat");
...
void UPerkWidgetNew_C::ShowTierImage()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShowTierImage");
...
void UPerkWidgetNew_C::SetupBadge()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetupBadge");
...
void UPerkWidgetNew_C::InitializeHeroBonusIcon()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeHeroBonusIcon");
...
void UPerkWidgetNew_C::ShouldFadePerk(bool* Result)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldFadePerk");
...
void UPerkWidgetNew_C::GetHighlightColor(struct FLinearColor* Color)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetHighlightColor");
...
void UPerkWidgetNew_C::GetTierAbilityBrush(struct FSlateBrush* SlateBrush)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetTierAbilityBrush");
...
void UPerkWidgetNew_C::InitializeAbilityPerk()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeAbilityPerk");
...
void UPerkWidgetNew_C::InitializeBasicPerk()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitializeBasicPerk");
...
void UPerkWidgetNew_C::OnCombinedTooltipDescriptionReady(const class FText& Description)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnCombinedTooltipDescriptionReady");
...
void UPerkWidgetNew_C::ExecuteUbergraph_PerkWidgetNew(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_PerkWidgetNew");
