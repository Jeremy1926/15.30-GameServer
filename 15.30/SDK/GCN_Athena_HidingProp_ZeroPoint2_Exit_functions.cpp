...
#include "GCN_Athena_HidingProp_ZeroPoint2_Exit_classes.hpp"
#include "GCN_Athena_HidingProp_ZeroPoint2_Exit_parameters.hpp"
...
void UGCN_Athena_HidingProp_ZeroPoint2_Exit_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_Athena_HidingProp_ZeroPoint2_Exit_C_OnBurst Parms{};
