...
static_assert(offsetof(BacchusQuickbarSlot_C_SetAnimatedBoxScaleFactor, AnimatedBoxScaleFactor_0) == 0x000000, "Member 'BacchusQuickbarSlot_C_SetAnimatedBoxScaleFactor::AnimatedBoxScaleFactor_0' has a wrong offset!");
...
static_assert(offsetof(BacchusQuickbarSlot_C_Create_Quantity_Selector_Widget, Item_0) == 0x000000, "Member 'BacchusQuickbarSlot_C_Create_Quantity_Selector_Widget::Item_0' has a wrong offset!");
...
static_assert(offsetof(BacchusQuickbarSlot_C_Handle_Drop_Item_Confirmation_Callback, Item_0) == 0x000008, "Member 'BacchusQuickbarSlot_C_Handle_Drop_Item_Confirmation_Callback::Item_0' has a wrong offset!");
