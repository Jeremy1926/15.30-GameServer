...
{
public:
	TMulticastInlineDelegate<void(class UAsyncAction_RegisterGameplayMessageReceiver* MessageResult)> OnMessageReceived;                                 // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
