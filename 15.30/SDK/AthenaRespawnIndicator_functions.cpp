...
void UAthenaRespawnIndicator_C::ExecuteUbergraph_AthenaRespawnIndicator(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaRespawnIndicator");
...
void UAthenaRespawnIndicator_C::OnUpdateLives(int32 Lives)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnUpdateLives");
...
void UAthenaRespawnIndicator_C::OnUpdateRespawnState(bool bEnabled)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnUpdateRespawnState");
...
void UAthenaRespawnIndicator_C::SetVisibilty(bool Visible)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetVisibilty");
...
void UAthenaRespawnIndicator_C::ToggleRespawnState(bool canRespawn_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleRespawnState");
