...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::ExecuteUbergraph_GA_Athena_ActivePower_LeapGlider_Parent(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GA_Athena_ActivePower_LeapGlider_Parent");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::HandleItemEquip()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleItemEquip");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::WeaponUnequipped()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("WeaponUnequipped");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::BoardDroppedMidGlide(const class UFortWorldItem* ItemDropped)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BoardDroppedMidGlide");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::GenericFailSafe()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GenericFailSafe");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::MovementModeChangeFailSafe(class ACharacter* Character, EMovementMode PrevMovementMode, uint8 PreviousCustomMode)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MovementModeChangeFailSafe");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::CleanupAbility()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CleanupAbility");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::OnSync_68C1AC134C9324B6EC0F089B02953286()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSync_68C1AC134C9324B6EC0F089B02953286");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::OnSync_3ADE1BE041AF08C4CB1C9FA374F2E496()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSync_3ADE1BE041AF08C4CB1C9FA374F2E496");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::EventReceived_46002FDB48565B7FA88DA089C488CA73(const struct FGameplayEventData& Payload)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EventReceived_46002FDB48565B7FA88DA089C488CA73");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::OnSync_48D3266A4217EF7058D7FCA507015CB5()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSync_48D3266A4217EF7058D7FCA507015CB5");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::Added_9CF55B3043720DD4EE05809F2B45DD91()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Added_9CF55B3043720DD4EE05809F2B45DD91");
...
void UGA_Athena_ActivePower_LeapGlider_Parent_C::OnSync_5B9655A74696A7C0515A278467F52358()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSync_5B9655A74696A7C0515A278467F52358");
