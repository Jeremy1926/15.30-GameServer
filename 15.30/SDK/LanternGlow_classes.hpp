...
static_assert(sizeof(ALanternGlow_C) == 0x000C90, "Wrong size on ALanternGlow_C");
static_assert(offsetof(ALanternGlow_C, PointLight) == 0x000C88, "Member 'ALanternGlow_C::PointLight' has a wrong offset!");
