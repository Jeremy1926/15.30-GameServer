...
static_assert(sizeof(UAthenaSessionId_C) == 0x0002D8, "Wrong size on UAthenaSessionId_C");
static_assert(offsetof(UAthenaSessionId_C, UberGraphFrame) == 0x0002C8, "Member 'UAthenaSessionId_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaSessionId_C, Text) == 0x0002D0, "Member 'UAthenaSessionId_C::Text' has a wrong offset!");
