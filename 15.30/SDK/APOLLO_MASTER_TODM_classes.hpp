...
static_assert(sizeof(AAPOLLO_MASTER_TODM_C) == 0x0010B0, "Wrong size on AAPOLLO_MASTER_TODM_C");
...
static_assert(offsetof(AAPOLLO_MASTER_TODM_C, Morning) == 0x001070, "Member 'AAPOLLO_MASTER_TODM_C::Morning' has a wrong offset!");
static_assert(offsetof(AAPOLLO_MASTER_TODM_C, Day) == 0x001080, "Member 'AAPOLLO_MASTER_TODM_C::Day' has a wrong offset!");
static_assert(offsetof(AAPOLLO_MASTER_TODM_C, Evening) == 0x001090, "Member 'AAPOLLO_MASTER_TODM_C::Evening' has a wrong offset!");
static_assert(offsetof(AAPOLLO_MASTER_TODM_C, Night) == 0x0010A0, "Member 'AAPOLLO_MASTER_TODM_C::Night' has a wrong offset!");
