...
void UChallengePunchCard_C::ExecuteUbergraph_ChallengePunchCard(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_ChallengePunchCard");
...
void UChallengePunchCard_C::UnfocusPunchCard()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UnfocusPunchCard");
...
void UChallengePunchCard_C::FocusPunchCard()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("FocusPunchCard");
...
void UChallengePunchCard_C::SetBangState(bool bShowBang)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetBangState");
...
void UChallengePunchCard_C::SetUpEncodedName(const class FString& Name_0, int32 Count)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetUpEncodedName");
...
void UChallengePunchCard_C::HideProgressCount(bool bBundleCompleted)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HideProgressCount");
...
void UChallengePunchCard_C::SetUnkownState(bool bKnown)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetUnkownState");
...
void UChallengePunchCard_C::SetProgressCount(int32 AchivedCount, int32 GoalCount)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetProgressCount");
