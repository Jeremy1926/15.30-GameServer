...
static_assert(sizeof(AAthena_Prop_Office_Desk_01_C) == 0x000C90, "Wrong size on AAthena_Prop_Office_Desk_01_C");
static_assert(offsetof(AAthena_Prop_Office_Desk_01_C, SpotLight) == 0x000C88, "Member 'AAthena_Prop_Office_Desk_01_C::SpotLight' has a wrong offset!");
