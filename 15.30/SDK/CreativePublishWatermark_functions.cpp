...
void UCreativePublishWatermark_C::ExecuteUbergraph_CreativePublishWatermark(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_CreativePublishWatermark");
...
void UCreativePublishWatermark_C::OnLinkedVolumeChanged(class AFortVolume* Volume)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLinkedVolumeChanged");
...
void UCreativePublishWatermark_C::Update_Watermark(class AFortVolume* Volume)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Watermark");
...
void UCreativePublishWatermark_C::SetTextCollapseIfDefault(class UTextBlock* Text_Widget, const class FString& InputText, const class FString& DefaultText)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetTextCollapseIfDefault");
