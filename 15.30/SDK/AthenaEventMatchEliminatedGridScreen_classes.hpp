...
static_assert(sizeof(UAthenaEventMatchEliminatedGridScreen_C) == 0x0004C8, "Wrong size on UAthenaEventMatchEliminatedGridScreen_C");
static_assert(offsetof(UAthenaEventMatchEliminatedGridScreen_C, UberGraphFrame) == 0x0004B8, "Member 'UAthenaEventMatchEliminatedGridScreen_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaEventMatchEliminatedGridScreen_C, EliminatedPlayersGrid) == 0x0004C0, "Member 'UAthenaEventMatchEliminatedGridScreen_C::EliminatedPlayersGrid' has a wrong offset!");
