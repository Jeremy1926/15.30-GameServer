...
static_assert(offsetof(BP_Item_Collection_Cluster_FragmentSpawner_C_DetonateCluster, CollectingActor_0) == 0x000008, "Member 'BP_Item_Collection_Cluster_FragmentSpawner_C_DetonateCluster::CollectingActor_0' has a wrong offset!");
