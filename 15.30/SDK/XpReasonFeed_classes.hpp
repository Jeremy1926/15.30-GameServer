...
static_assert(sizeof(UXpReasonFeed_C) == 0x000278, "Wrong size on UXpReasonFeed_C");
static_assert(offsetof(UXpReasonFeed_C, UberGraphFrame) == 0x000260, "Member 'UXpReasonFeed_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UXpReasonFeed_C, DynamicXpFeed) == 0x000268, "Member 'UXpReasonFeed_C::DynamicXpFeed' has a wrong offset!");
static_assert(offsetof(UXpReasonFeed_C, Animating) == 0x000270, "Member 'UXpReasonFeed_C::Animating' has a wrong offset!");
