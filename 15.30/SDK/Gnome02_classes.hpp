...
static_assert(sizeof(AGnome02_C) == 0x000BB0, "Wrong size on AGnome02_C");
static_assert(offsetof(AGnome02_C, UberGraphFrame) == 0x000BA8, "Member 'AGnome02_C::UberGraphFrame' has a wrong offset!");
