...
void UChallengePunchCardEntry_C::ExecuteUbergraph_ChallengePunchCardEntry(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_ChallengePunchCardEntry");
...
void UChallengePunchCardEntry_C::Play_Place_Stamp()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Play Place Stamp");
...
void UChallengePunchCardEntry_C::SetToDefaultSlot()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetToDefaultSlot");
...
void UChallengePunchCardEntry_C::OnPlacedEntry()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnPlacedEntry");
...
void UChallengePunchCardEntry_C::SetIsFirstSlot()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetIsFirstSlot");
...
void UChallengePunchCardEntry_C::SetIsLastSlot()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetIsLastSlot");
...
void UChallengePunchCardEntry_C::SetIsNonsequentialSlot()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetIsNonsequentialSlot");
