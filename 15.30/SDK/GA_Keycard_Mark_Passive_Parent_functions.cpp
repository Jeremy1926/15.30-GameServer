...
void UGA_Keycard_Mark_Passive_Parent_C::ExecuteUbergraph_GA_Keycard_Mark_Passive_Parent(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_GA_Keycard_Mark_Passive_Parent");
...
void UGA_Keycard_Mark_Passive_Parent_C::ReplicatedDrawTrailToVault(const struct FRotator& Rotation)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ReplicatedDrawTrailToVault");
...
void UGA_Keycard_Mark_Passive_Parent_C::DrawTrailToVault()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("DrawTrailToVault");
...
void UGA_Keycard_Mark_Passive_Parent_C::OnSync_5619E23F4D1F97AAF6EB6C8A62F04951()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnSync_5619E23F4D1F97AAF6EB6C8A62F04951");
