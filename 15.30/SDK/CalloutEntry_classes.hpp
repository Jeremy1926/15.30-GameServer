...
static_assert(sizeof(UCalloutEntry_C) == 0x000270, "Wrong size on UCalloutEntry_C");
static_assert(offsetof(UCalloutEntry_C, Intro) == 0x000260, "Member 'UCalloutEntry_C::Intro' has a wrong offset!");
static_assert(offsetof(UCalloutEntry_C, Callout) == 0x000268, "Member 'UCalloutEntry_C::Callout' has a wrong offset!");
