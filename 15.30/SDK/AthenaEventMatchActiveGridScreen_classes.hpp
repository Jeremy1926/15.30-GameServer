...
static_assert(sizeof(UAthenaEventMatchActiveGridScreen_C) == 0x0004C8, "Wrong size on UAthenaEventMatchActiveGridScreen_C");
static_assert(offsetof(UAthenaEventMatchActiveGridScreen_C, UberGraphFrame) == 0x0004B8, "Member 'UAthenaEventMatchActiveGridScreen_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaEventMatchActiveGridScreen_C, ActivePlayersGrid) == 0x0004C0, "Member 'UAthenaEventMatchActiveGridScreen_C::ActivePlayersGrid' has a wrong offset!");
