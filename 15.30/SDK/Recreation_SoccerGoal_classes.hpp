...
public:
	...
	class UStaticMeshComponent*                   StaticMesh_NetCollision;                           // 0x0BB0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ARecreation_SoccerGoal_C) == 0x000BB8, "Wrong size on ARecreation_SoccerGoal_C");
static_assert(offsetof(ARecreation_SoccerGoal_C, UberGraphFrame) == 0x000BA8, "Member 'ARecreation_SoccerGoal_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ARecreation_SoccerGoal_C, StaticMesh_NetCollision) == 0x000BB0, "Member 'ARecreation_SoccerGoal_C::StaticMesh_NetCollision' has a wrong offset!");
