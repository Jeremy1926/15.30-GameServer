...
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, Message_0) == 0x000008, "Member 'Cr_ChBrowserMessage_C_Populate::Message_0' has a wrong offset!");
static_assert(offsetof(Cr_ChBrowserMessage_C_Populate, Channel_0) == 0x000020, "Member 'Cr_ChBrowserMessage_C_Populate::Channel_0' has a wrong offset!");
