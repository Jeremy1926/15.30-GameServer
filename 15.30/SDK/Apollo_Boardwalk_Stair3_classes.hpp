...
{
public:
	class UAudioComponent*                        WoodCreakSound;                                    // 0x0AD0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AApollo_Boardwalk_Stair3_C) == 0x000AD8, "Wrong size on AApollo_Boardwalk_Stair3_C");
static_assert(offsetof(AApollo_Boardwalk_Stair3_C, WoodCreakSound) == 0x000AD0, "Member 'AApollo_Boardwalk_Stair3_C::WoodCreakSound' has a wrong offset!");
