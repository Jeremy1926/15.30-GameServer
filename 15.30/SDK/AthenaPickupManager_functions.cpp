...
void UAthenaPickupManager_C::ExecuteUbergraph_AthenaPickupManager(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaPickupManager");
...
void UAthenaPickupManager_C::InvalidateAllPackResources()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InvalidateAllPackResources");
...
void UAthenaPickupManager_C::HandleItemPickup(class UFortWorldItem* NewItem, int32 Count)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleItemPickup");
...
void UAthenaPickupManager_C::HandleBuildingMaterialChanged()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleBuildingMaterialChanged");
...
void UAthenaPickupManager_C::RefreshCounts()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RefreshCounts");
...
void UAthenaPickupManager_C::RefreshBackground()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RefreshBackground");
...
void UAthenaPickupManager_C::HandleSetWorldResourceWidgetVisibility(EFortResourceType ResourceType, bool bVisible)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleSetWorldResourceWidgetVisibility");
...
void UAthenaPickupManager_C::UpdateWorldResourceWidgetsVisibility()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateWorldResourceWidgetsVisibility");
