...
void UBacchusQuickbarSlot_C::ExecuteUbergraph_BacchusQuickbarSlot(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BacchusQuickbarSlot");
...
void UBacchusQuickbarSlot_C::StartOngoingUse(int32 PointerIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartOngoingUse");
...
void UBacchusQuickbarSlot_C::Handle_OnQuickbarContentsChanged(EFortQuickBars QuickbarIndex, const TArray<int32>& ChangedSlots)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Handle OnQuickbarContentsChanged");
...
void UBacchusQuickbarSlot_C::Create_Quantity_Selector_Widget(class UFortWorldItem* Item_0, const class FText& Confirmation_Text)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Create Quantity Selector Widget");
...
void UBacchusQuickbarSlot_C::Handle_Drop_Item_Confirmation_Callback(int32 Chosen_Quanitity, class UFortItem* Item_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Handle Drop Item Confirmation Callback");
...
void UBacchusQuickbarSlot_C::Destroy_Quanitity_Selector_Widget()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Destroy Quanitity Selector Widget");
...
void UBacchusQuickbarSlot_C::End_Interaction_BP(int32 Pointer_Index)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("End Interaction_BP");
...
void UBacchusQuickbarSlot_C::Cancel_Interaction()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Cancel Interaction");
...
void UBacchusQuickbarSlot_C::StartOngoingUse_BP(int32 PointerIndex)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("StartOngoingUse_BP");
...
void UBacchusQuickbarSlot_C::Update_Item_Box_Size_Native()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Update Item Box Size Native");
...
void UBacchusQuickbarSlot_C::Setup_Multi_Slot_Indicators()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Setup Multi Slot Indicators");
