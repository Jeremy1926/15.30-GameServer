...
static_assert(offsetof(AthenaQuickbarSlotBase_C_InitializeCooldowns, K2Node_CreateDelegate_OutputDelegate) == 0x000000, "Member 'AthenaQuickbarSlotBase_C_InitializeCooldowns::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(AthenaQuickbarSlotBase_C_InitializeCooldowns, K2Node_CreateDelegate_OutputDelegate_1) == 0x000010, "Member 'AthenaQuickbarSlotBase_C_InitializeCooldowns::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(AthenaQuickbarSlotBase_C_InitializeCooldowns, K2Node_DynamicCast_AsQuickbar_Slot_Cooldown) == 0x000020, "Member 'AthenaQuickbarSlotBase_C_InitializeCooldowns::K2Node_DynamicCast_AsQuickbar_Slot_Cooldown' has a wrong offset!");
static_assert(offsetof(AthenaQuickbarSlotBase_C_InitializeCooldowns, K2Node_DynamicCast_bSuccess) == 0x000028, "Member 'AthenaQuickbarSlotBase_C_InitializeCooldowns::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(alignof(AthenaQuickbarSlotBase_C_OnCooldownStarted) == 0x000004, "Wrong alignment on AthenaQuickbarSlotBase_C_OnCooldownStarted");
static_assert(sizeof(AthenaQuickbarSlotBase_C_OnCooldownStarted) == 0x00000C, "Wrong size on AthenaQuickbarSlotBase_C_OnCooldownStarted");
...
static_assert(offsetof(AthenaQuickbarSlotBase_C_OnCooldownStarted, CooldownDuration) == 0x000004, "Member 'AthenaQuickbarSlotBase_C_OnCooldownStarted::CooldownDuration' has a wrong offset!");
static_assert(offsetof(AthenaQuickbarSlotBase_C_OnCooldownStarted, K2Node_SwitchEnum_CmpSuccess) == 0x000008, "Member 'AthenaQuickbarSlotBase_C_OnCooldownStarted::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(alignof(AthenaQuickbarSlotBase_C_RemoveUnusedSlotVisual) == 0x000001, "Wrong alignment on AthenaQuickbarSlotBase_C_RemoveUnusedSlotVisual");
static_assert(sizeof(AthenaQuickbarSlotBase_C_RemoveUnusedSlotVisual) == 0x000001, "Wrong size on AthenaQuickbarSlotBase_C_RemoveUnusedSlotVisual");
static_assert(offsetof(AthenaQuickbarSlotBase_C_RemoveUnusedSlotVisual, CallFunc_IsInAthena_ReturnValue) == 0x000000, "Member 'AthenaQuickbarSlotBase_C_RemoveUnusedSlotVisual::CallFunc_IsInAthena_ReturnValue' has a wrong offset!");
