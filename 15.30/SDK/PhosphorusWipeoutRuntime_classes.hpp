...
public:
	...
	TMulticastInlineDelegate<void(struct FPhosphorusWipeoutKnockBackData& KnockBackData)> PhosphorusWipeoutOnAllPlayersKnockBackDataChanged; // 0x07C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
