...
static_assert(sizeof(AAthena_Prop_BP_TRV_tall_shelf_01_C) == 0x000BC0, "Wrong size on AAthena_Prop_BP_TRV_tall_shelf_01_C");
static_assert(offsetof(AAthena_Prop_BP_TRV_tall_shelf_01_C, UberGraphFrame) == 0x000BA8, "Member 'AAthena_Prop_BP_TRV_tall_shelf_01_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_BP_TRV_tall_shelf_01_C, Sound_Flies) == 0x000BB0, "Member 'AAthena_Prop_BP_TRV_tall_shelf_01_C::Sound_Flies' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_BP_TRV_tall_shelf_01_C, Flies) == 0x000BB8, "Member 'AAthena_Prop_BP_TRV_tall_shelf_01_C::Flies' has a wrong offset!");
