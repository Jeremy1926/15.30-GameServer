...
static_assert(sizeof(UAthenaGamePhaseWidget_C) == 0x0002F8, "Wrong size on UAthenaGamePhaseWidget_C");
static_assert(offsetof(UAthenaGamePhaseWidget_C, UberGraphFrame) == 0x0002E8, "Member 'UAthenaGamePhaseWidget_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaGamePhaseWidget_C, Icon) == 0x0002F0, "Member 'UAthenaGamePhaseWidget_C::Icon' has a wrong offset!");
