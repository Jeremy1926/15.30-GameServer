...
#include "HidingProp_ZeroPointEnergery_PlayerCameraModifier_classes.hpp"
#include "HidingProp_ZeroPointEnergery_PlayerCameraModifier_parameters.hpp"
...
void UHidingProp_ZeroPointEnergery_PlayerCameraModifier_C::BlueprintModifyCamera(float DeltaTime, const struct FVector& ViewLocation, const struct FRotator& ViewRotation, float FOV, struct FVector* NewViewLocation, struct FRotator* NewViewRotation, float* NewFOV)
{
	...
	Params::HidingProp_ZeroPointEnergery_PlayerCameraModifier_C_BlueprintModifyCamera Parms{};
