...
public:
	...
	TDelegate<void(TScriptInterface<class IFortSafeZoneInterface>& SafeZoneInterface, EAthenaGamePhaseStep GamePhaseStep)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0028(0x0010)(ZeroConstructor, NoDestructor)
	...
	TScriptInterface<class IFortSafeZoneInterface> K2Node_CustomEvent_SafeZoneInterface;              // 0x0040(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	EAthenaGamePhaseStep                          K2Node_CustomEvent_GamePhaseStep;                  // 0x0050(0x0001)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AAthena_GameState_C*                    K2Node_DynamicCast_AsAthena_Game_State;            // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAudioComponent*                        CallFunc_SpawnSoundAttached_ReturnValue_2;         // 0x0078(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AActor*>                         CallFunc_GetAllActorsWithTag_OutActors;            // 0x0090(0x0010)(ReferenceParm, HasGetValueTypeHash)
	...
	class ACar_DEFAULT_C*                         K2Node_DynamicCast_AsCar_DEFAULT;                  // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController) == 0x0000C8, "Wrong size on BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController");
...
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_IsDedicatedServer_ReturnValue) == 0x000018, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, Temp_int_Loop_Counter_Variable) == 0x00001C, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_Add_IntInt_ReturnValue) == 0x000020, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, Temp_int_Array_Index_Variable) == 0x000024, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_CreateDelegate_OutputDelegate_1) == 0x000028, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_GetGameState_ReturnValue) == 0x000038, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_CustomEvent_SafeZoneInterface) == 0x000040, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_CustomEvent_SafeZoneInterface' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_CustomEvent_GamePhaseStep) == 0x000050, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_CustomEvent_GamePhaseStep' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_DynamicCast_AsAthena_Game_State) == 0x000058, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_DynamicCast_AsAthena_Game_State' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_DynamicCast_bSuccess) == 0x000060, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_SwitchEnum_CmpSuccess) == 0x000061, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_SpawnSoundAttached_ReturnValue) == 0x000068, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_SpawnSoundAttached_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_SpawnSoundAttached_ReturnValue_1) == 0x000070, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_SpawnSoundAttached_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_SpawnSoundAttached_ReturnValue_2) == 0x000078, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_SpawnSoundAttached_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000084, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_GetAllActorsWithTag_OutActors) == 0x000090, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_GetAllActorsWithTag_OutActors' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_Array_Get_Item) == 0x0000A0, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_Array_Get_Item_1) == 0x0000A8, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_DynamicCast_AsCar_DEFAULT) == 0x0000B0, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_DynamicCast_AsCar_DEFAULT' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, K2Node_DynamicCast_bSuccess_1) == 0x0000B8, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_Array_Length_ReturnValue) == 0x0000BC, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController, CallFunc_Less_IntInt_ReturnValue) == 0x0000C0, "Member 'BP_Bus_Lobby_SoundController_C_ExecuteUbergraph_BP_Bus_Lobby_SoundController::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
