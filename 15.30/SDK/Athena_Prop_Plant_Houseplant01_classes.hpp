...
{
public:
	class UParticleSystemComponent*               Loot_Effect;                                       // 0x0C88(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AAthena_Prop_Plant_Houseplant01_C) == 0x000C90, "Wrong size on AAthena_Prop_Plant_Houseplant01_C");
static_assert(offsetof(AAthena_Prop_Plant_Houseplant01_C, Loot_Effect) == 0x000C88, "Member 'AAthena_Prop_Plant_Houseplant01_C::Loot_Effect' has a wrong offset!");
