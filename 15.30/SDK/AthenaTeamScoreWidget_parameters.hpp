...
static_assert(offsetof(AthenaTeamScoreWidget_C_UpdateLeaderboard, isWinner_0) == 0x000004, "Member 'AthenaTeamScoreWidget_C_UpdateLeaderboard::isWinner_0' has a wrong offset!");
