...
public:
	...
	class UConsolidatedQuestComponent*            QuestComponent;                                    // 0x07D8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABGA_BaseQuestObject_C) == 0x0007E8, "Wrong size on ABGA_BaseQuestObject_C");
static_assert(offsetof(ABGA_BaseQuestObject_C, UberGraphFrame) == 0x0007D0, "Member 'ABGA_BaseQuestObject_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABGA_BaseQuestObject_C, QuestComponent) == 0x0007D8, "Member 'ABGA_BaseQuestObject_C::QuestComponent' has a wrong offset!");
static_assert(offsetof(ABGA_BaseQuestObject_C, DefaultSceneRoot) == 0x0007E0, "Member 'ABGA_BaseQuestObject_C::DefaultSceneRoot' has a wrong offset!");
