...
static_assert(offsetof(CommonBigHealthBar_C_Update_Max_HP_Value, max_0) == 0x000000, "Member 'CommonBigHealthBar_C_Update_Max_HP_Value::max_0' has a wrong offset!");
