...
public:
	...
	class UMaterialInterface*                     CallFunc_GetMaterial_ReturnValue;                  // 0x0148(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_Conv_ObjectToString_ReturnValue;          // 0x0150(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UWaterSubsystem*                        CallFunc_GetWorldSubsystem_ReturnValue;            // 0x0198(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)> K2Node_CreateDelegate_OutputDelegate;              // 0x01A0(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsShallowWaterSimulationEnabled_ReturnValue; // 0x01B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1B1[0x7];                                      // 0x01B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWaterSubsystem*                        CallFunc_GetWorldSubsystem_ReturnValue_1;          // 0x01B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x01C0(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_2;            // 0x01D0(0x0010)(ZeroConstructor, NoDestructor)
	TArray<class ABP_FluidSim_FN_C*>              CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x01E0(0x0010)(ReferenceParm, HasGetValueTypeHash)
	class ABP_FluidSim_FN_C*                      CallFunc_Array_Get_Item_1;                         // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf) == 0x000200, "Wrong size on BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf");
...
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_IsValid_ReturnValue_2) == 0x000140, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_GetMaterial_ReturnValue) == 0x000148, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_GetMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_Conv_ObjectToString_ReturnValue) == 0x000150, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_Conv_ObjectToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_Concat_StrStr_ReturnValue) == 0x000160, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_Conv_StringToName_ReturnValue) == 0x000170, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_CreateDynamicMaterialInstance_ReturnValue) == 0x000178, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_CreateDynamicMaterialInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_HasMatchingGameplayTag_self_CastInput) == 0x000180, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_HasMatchingGameplayTag_self_CastInput' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_HasMatchingGameplayTag_ReturnValue) == 0x000190, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_HasMatchingGameplayTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_GetWorldSubsystem_ReturnValue) == 0x000198, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_GetWorldSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, K2Node_CreateDelegate_OutputDelegate) == 0x0001A0, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_IsShallowWaterSimulationEnabled_ReturnValue) == 0x0001B0, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_IsShallowWaterSimulationEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_GetWorldSubsystem_ReturnValue_1) == 0x0001B8, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_GetWorldSubsystem_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, K2Node_CreateDelegate_OutputDelegate_1) == 0x0001C0, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, K2Node_CreateDelegate_OutputDelegate_2) == 0x0001D0, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_GetAllActorsOfClass_OutActors_1) == 0x0001E0, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_GetAllActorsOfClass_OutActors_1' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_Array_Get_Item_1) == 0x0001F0, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_IsValid_ReturnValue_3) == 0x0001F8, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf, CallFunc_IsValid_ReturnValue_4) == 0x0001F9, "Member 'BGA_SuperSilkyWolf_C_ExecuteUbergraph_BGA_SuperSilkyWolf::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
