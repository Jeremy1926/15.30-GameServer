...
public:
	...
	struct FScalableFloat                         HotfixValue;                                       // 0x0308(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          EnableVideo;                                       // 0x0330(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          EnableAudio;                                       // 0x0331(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_332[0x6];                                      // 0x0332(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           SharingCheckTimer;                                 // 0x0338(0x0008)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          ScreenRecording;                                   // 0x0340(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          ScreenRecordingLast;                               // 0x0341(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_342[0x2];                                      // 0x0342(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PIPVersionSinglePlayer;                            // 0x0344(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         PIPVersionMirror;                                  // 0x0348(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          DisabledSharing;                                   // 0x034C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(ABP_RiskyVideoScreen_01_C) == 0x000350, "Wrong size on ABP_RiskyVideoScreen_01_C");
...
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, EnableVideo) == 0x000330, "Member 'ABP_RiskyVideoScreen_01_C::EnableVideo' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, EnableAudio) == 0x000331, "Member 'ABP_RiskyVideoScreen_01_C::EnableAudio' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, SharingCheckTimer) == 0x000338, "Member 'ABP_RiskyVideoScreen_01_C::SharingCheckTimer' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, ScreenRecording) == 0x000340, "Member 'ABP_RiskyVideoScreen_01_C::ScreenRecording' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, ScreenRecordingLast) == 0x000341, "Member 'ABP_RiskyVideoScreen_01_C::ScreenRecordingLast' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, PIPVersionSinglePlayer) == 0x000344, "Member 'ABP_RiskyVideoScreen_01_C::PIPVersionSinglePlayer' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, PIPVersionMirror) == 0x000348, "Member 'ABP_RiskyVideoScreen_01_C::PIPVersionMirror' has a wrong offset!");
static_assert(offsetof(ABP_RiskyVideoScreen_01_C, DisabledSharing) == 0x00034C, "Member 'ABP_RiskyVideoScreen_01_C::DisabledSharing' has a wrong offset!");
