...
static_assert(sizeof(UAthenaKillFeedItem_C) == 0x0002D0, "Wrong size on UAthenaKillFeedItem_C");
static_assert(offsetof(UAthenaKillFeedItem_C, KillText) == 0x0002C8, "Member 'UAthenaKillFeedItem_C::KillText' has a wrong offset!");
