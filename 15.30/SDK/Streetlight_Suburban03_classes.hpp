...
static_assert(sizeof(AStreetlight_Suburban03_C) == 0x000C90, "Wrong size on AStreetlight_Suburban03_C");
static_assert(offsetof(AStreetlight_Suburban03_C, SpotLight) == 0x000C88, "Member 'AStreetlight_Suburban03_C::SpotLight' has a wrong offset!");
