...
void UAthenaLocalPlayerHitPointInfo_C::ExecuteUbergraph_AthenaLocalPlayerHitPointInfo(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_AthenaLocalPlayerHitPointInfo");
...
void UAthenaLocalPlayerHitPointInfo_C::OnPawnHealthChanged_Event()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnPawnHealthChanged_Event");
...
void UAthenaLocalPlayerHitPointInfo_C::OnCreativeModeEnabledChanged(bool bIsEnabled_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnCreativeModeEnabledChanged");
