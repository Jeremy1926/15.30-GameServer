...
void AParticle_Deco_C::ExecuteUbergraph_Particle_Deco(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Particle_Deco");
...
void AParticle_Deco_C::ActivateDecoEmitter()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ActivateDecoEmitter");
...
// struct FVector                          ParticleScale_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector                          RandomScale                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AParticle_Deco_C::PseudoRandomScale(const struct FVector& ActorLocation, const struct FVector& ParticleScale_0, struct FVector* RandomScale)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("PseudoRandomScale");
	...
	if (RandomScale != nullptr)
		*RandomScale = std::move(Parms.RandomScale);
}
