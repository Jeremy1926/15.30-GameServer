...
void ATrap_Athena_Spikes_C::ExecuteUbergraph_Trap_Athena_Spikes(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_Trap_Athena_Spikes");
...
void ATrap_Athena_Spikes_C::OnInitTeam()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnInitTeam");
...
void ATrap_Athena_Spikes_C::OnLoaded_8A9D6DF7414FFDD42BE9FCB155F39B4D(class UObject* Loaded)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLoaded_8A9D6DF7414FFDD42BE9FCB155F39B4D");
...
void ATrap_Athena_Spikes_C::OnLoaded_8E622EE64F2AF153BE7162BA1D8EBCC1(class UObject* Loaded)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnLoaded_8E622EE64F2AF153BE7162BA1D8EBCC1");
...
void ATrap_Athena_Spikes_C::ResetSpikes__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ResetSpikes__UpdateFunc");
...
void ATrap_Athena_Spikes_C::ResetSpikes__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ResetSpikes__FinishedFunc");
...
void ATrap_Athena_Spikes_C::Retract__Sounds__EventFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Retract__Sounds__EventFunc");
...
void ATrap_Athena_Spikes_C::Retract__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Retract__UpdateFunc");
...
void ATrap_Athena_Spikes_C::Retract__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Retract__FinishedFunc");
...
void ATrap_Athena_Spikes_C::Fire__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Fire__UpdateFunc");
...
void ATrap_Athena_Spikes_C::Fire__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Fire__FinishedFunc");
...
void ATrap_Athena_Spikes_C::SetSpikePosition(float NewSpikePosition)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetSpikePosition");
...
void ATrap_Athena_Spikes_C::MaterialSweepOnSpikes(float SweepSpeed_0, const struct FLinearColor& SweepColor_0, float SweepExponent_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MaterialSweepOnSpikes");
...
void ATrap_Athena_Spikes_C::_ChangeToFriendlyMaterial()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction(" ChangeToFriendlyMaterial");
...
void ATrap_Athena_Spikes_C::ChangeToNormalMaterial()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ChangeToNormalMaterial");
