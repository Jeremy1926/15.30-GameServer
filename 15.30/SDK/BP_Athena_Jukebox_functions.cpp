...
void ABP_Athena_Jukebox_C::ExecuteUbergraph_BP_Athena_Jukebox(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_BP_Athena_Jukebox");
...
void ABP_Athena_Jukebox_C::Pitch_Bend__UpdateFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Pitch Bend__UpdateFunc");
...
void ABP_Athena_Jukebox_C::Pitch_Bend__FinishedFunc()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Pitch Bend__FinishedFunc");
