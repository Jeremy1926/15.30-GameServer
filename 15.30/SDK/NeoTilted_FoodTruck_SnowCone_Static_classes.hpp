...
{
public:
	class UStaticMeshComponent*                   SM_NeoT_FoodTruck_Durr;                            // 0x0D98(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ANeoTilted_FoodTruck_SnowCone_Static_C) == 0x000DA0, "Wrong size on ANeoTilted_FoodTruck_SnowCone_Static_C");
static_assert(offsetof(ANeoTilted_FoodTruck_SnowCone_Static_C, SM_NeoT_FoodTruck_Durr) == 0x000D98, "Member 'ANeoTilted_FoodTruck_SnowCone_Static_C::SM_NeoT_FoodTruck_Durr' has a wrong offset!");
