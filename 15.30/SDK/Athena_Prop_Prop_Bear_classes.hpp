...
public:
	...
	bool                                          Effects;                                           // 0x0BB0(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor)
...
static_assert(sizeof(AAthena_Prop_Prop_Bear_C) == 0x000BB8, "Wrong size on AAthena_Prop_Prop_Bear_C");
static_assert(offsetof(AAthena_Prop_Prop_Bear_C, UberGraphFrame) == 0x000BA8, "Member 'AAthena_Prop_Prop_Bear_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_Prop_Bear_C, Effects) == 0x000BB0, "Member 'AAthena_Prop_Prop_Bear_C::Effects' has a wrong offset!");
