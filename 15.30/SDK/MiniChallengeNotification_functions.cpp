...
void UMiniChallengeNotification_C::ExecuteUbergraph_MiniChallengeNotification(int32 EntryPoint)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_MiniChallengeNotification");
...
void UMiniChallengeNotification_C::Play_Inro_Sound()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("Play Inro Sound");
...
void UMiniChallengeNotification_C::TriggerXpToast_Event_0()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TriggerXpToast_Event_0");
...
void UMiniChallengeNotification_C::MiniChallengeToastFinished()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("MiniChallengeToastFinished");
