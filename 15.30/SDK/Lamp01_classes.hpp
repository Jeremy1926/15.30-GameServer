...
static_assert(sizeof(ALamp01_C) == 0x000C90, "Wrong size on ALamp01_C");
static_assert(offsetof(ALamp01_C, PointLight) == 0x000C88, "Member 'ALamp01_C::PointLight' has a wrong offset!");
