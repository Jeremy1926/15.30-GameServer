...
public:
	...
	TDelegate<void(class AFortGameStateAthena* GameState, class UFortPlaylist* Playlist, struct FGameplayTagContainer& PlaylistContextTags)> K2Node_CreateDelegate_OutputDelegate;              // 0x009C(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(offsetof(AthenaCountdown_C_ExecuteUbergraph_AthenaCountdown, CallFunc_IsValid_ReturnValue_1) == 0x000098, "Member 'AthenaCountdown_C_ExecuteUbergraph_AthenaCountdown::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AthenaCountdown_C_ExecuteUbergraph_AthenaCountdown, K2Node_CreateDelegate_OutputDelegate) == 0x00009C, "Member 'AthenaCountdown_C_ExecuteUbergraph_AthenaCountdown::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
