...
static_assert(sizeof(PostGameSpectatingPlayerName_C_ExecuteUbergraph_PostGameSpectatingPlayerName) == 0x0000C8, "Wrong size on PostGameSpectatingPlayerName_C_ExecuteUbergraph_PostGameSpectatingPlayerName");
...
static_assert(offsetof(PostGameSpectatingPlayerName_C_ExecuteUbergraph_PostGameSpectatingPlayerName, K2Node_MakeArray_Array) == 0x0000A0, "Member 'PostGameSpectatingPlayerName_C_ExecuteUbergraph_PostGameSpectatingPlayerName::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(PostGameSpectatingPlayerName_C_ExecuteUbergraph_PostGameSpectatingPlayerName, CallFunc_Format_ReturnValue) == 0x0000B0, "Member 'PostGameSpectatingPlayerName_C_ExecuteUbergraph_PostGameSpectatingPlayerName::CallFunc_Format_ReturnValue' has a wrong offset!");
