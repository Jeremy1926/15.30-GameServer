...
static_assert(sizeof(UAthenaBroadcastHUDMenuStatusLayer_C) == 0x0002E8, "Wrong size on UAthenaBroadcastHUDMenuStatusLayer_C");
static_assert(offsetof(UAthenaBroadcastHUDMenuStatusLayer_C, UberGraphFrame) == 0x0002D8, "Member 'UAthenaBroadcastHUDMenuStatusLayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UAthenaBroadcastHUDMenuStatusLayer_C, HUDMenuStatusCanvas) == 0x0002E0, "Member 'UAthenaBroadcastHUDMenuStatusLayer_C::HUDMenuStatusCanvas' has a wrong offset!");
