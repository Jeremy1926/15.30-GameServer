...
UFortWorldItem* Inventory::GiveItem(AFortPlayerController* PlayerController, UFortItemDefinition* Def, int Count, int LoadedAmmo, int Level, bool ShowPickupNoti, bool updateInventory, int PhantomReserveAmmo)
{
	...
	if (auto Gadget = Def->Cast<UFortGadgetItemDefinition>())
		((bool(*)(UFortGadgetItemDefinition*, IInterface*, UFortWorldItem*, uint8)) (ImageBase + 0x28fa480))(Gadget, Utils::GetInterface<IFortInventoryOwnerInterface>(PlayerController), Item, 1);
...
void Inventory::Remove(AFortPlayerController* PlayerController, FGuid Guid)
{
	...
	if (Instance)
		if (auto Gadget = Instance->ItemEntry.ItemDefinition->Cast<UFortGadgetItemDefinition>())
			((bool(*)(UFortGadgetItemDefinition*, IInterface*, UFortWorldItem*)) (ImageBase + 0x28fcf10))(Gadget, Utils::GetInterface<IFortInventoryOwnerInterface>(PlayerController), Instance);
...
void Inventory::Hook() {
	...
	Utils::Hook<AFortPlayerControllerAthena>(uint32(0x20d), ServerRemoveInventoryItem);
